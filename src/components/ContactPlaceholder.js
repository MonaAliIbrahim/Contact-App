    ...
    Array(6).fill({}).map((item, index) => {
      return(
        <CardHeader 
          ...
          className="animate-pulse flex items-center content-start py-0 px-1 m-0 bg-white"
        >
          <div className="w-12 h-10 rounded-full bg-gray-200 mr-2"></div>
          <div className="self-stretch flex flex-col w-full gap-y-2 !text-sm border-b-[1px] py-2">
